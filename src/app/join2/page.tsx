...
function useJoin() {
    ...
    const confirmEmail= useRef<HTMLInputElement | null>(null);
    ...
    const onEmailHandler = useCallback((event:any)=> {
    ...
    return (
        ...
        <div className="bg-white">
            ...
            <form>
                ...
                <div ><input name="email" type="email" ref={confirmEmail} placeholder="이메일" value={email} onChange={onEmailHandler} className="focus:bg-sky-100 block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></input></div>
